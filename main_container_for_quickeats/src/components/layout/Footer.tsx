...
/**
 * Footer component containing links and information for QuickEats
 */
    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* QuickEats section */}
          <div>
            <h3 className="text-lg font-bold mb-4">QuickEats</h3>
            <p className="text-gray-400 text-sm">
              Connecting hungry people with the best local restaurants for 
              seamless ordering, tracking, and delivery of delicious meals.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <Link href="/support" className="hover:text-orange-400">
                  Support Center
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center">
                ...
                123 Delivery Street, Foodtown, FT 12345
              </li>
            </ul>
          </div>
        </div>
